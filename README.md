...
Lai palaistu programmu, nepieciešams datorā instalēts Python (versija 3.x). Papildus bibliotēkas nav nepieciešamas, jo tiek izmantots iebūvētais tkinter modulis. Programmu var palaist, saglabājot kodu failā, piemēram, game.py, un izpildot to ar komandu:
